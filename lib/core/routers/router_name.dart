...
const searchResultsRoutePath = '/search/results';
const searchTagRoutePath = '/search/tag';
...
const String searchResultsRouteName = 'searchResults';
const String searchTagRouteName = 'searchTag';
